...
namespace IIS.Fotokiosk4
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk4.ВидОплаты fСпособОпл;
        ...
        public virtual IIS.Fotokiosk4.ВидОплаты СпособОпл
        {
            get
            {
                ...
                IIS.Fotokiosk4.ВидОплаты result = this.fСпособОпл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Fotokiosk4.Оплата));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОплатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаL", typeof(IIS.Fotokiosk4.Оплата));
                }
            }
        }
    }
