...
namespace IIS.Fotokiosk4
{
    ...
    public class ДопНастройки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk4.СделатьФото fСделатьФото;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Fotokiosk4.СделатьФото.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "СделатьФото"})]
        public virtual IIS.Fotokiosk4.СделатьФото СделатьФото
        {
            get
            {
                ...
                IIS.Fotokiosk4.СделатьФото result = this.fСделатьФото;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДопНастройкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДопНастройкиE", typeof(IIS.Fotokiosk4.ДопНастройки));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДопНастройки : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Fotokiosk4.DetailArrayOfДопНастройки members)

        // *** End programmer edit section *** (IIS.Fotokiosk4.DetailArrayOfДопНастройки members)
        ...
        /// </summary>
        public DetailArrayOfДопНастройки(IIS.Fotokiosk4.СделатьФото fСделатьФото) : 
                base(typeof(ДопНастройки), ((ICSSoft.STORMNET.DataObject)(fСделатьФото)))
        {
        }
        
        public IIS.Fotokiosk4.ДопНастройки this[int index]
        {
            get
            {
                return ((IIS.Fotokiosk4.ДопНастройки)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Fotokiosk4.ДопНастройки dataobject)
        {
