...
namespace IIS.Fotokiosk4
{
    ...
    public class СделатьФото : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk4.Категория fКатегорФото;
        
        private int fЦена;
        
        private IIS.Fotokiosk4.DetailArrayOfДопНастройки fДопНастройки;
        ...
        public virtual IIS.Fotokiosk4.Категория КатегорФото
        {
            get
            {
                ...
                IIS.Fotokiosk4.Категория result = this.fКатегорФото;
        ...
        public virtual IIS.Fotokiosk4.DetailArrayOfДопНастройки ДопНастройки
        {
            get
            {
                ...
                {
                    this.fДопНастройки = new IIS.Fotokiosk4.DetailArrayOfДопНастройки(this);
                }
                IIS.Fotokiosk4.DetailArrayOfДопНастройки result = this.fДопНастройки;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СделатьФотоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СделатьФотоE", typeof(IIS.Fotokiosk4.СделатьФото));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СделатьФотоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СделатьФотоL", typeof(IIS.Fotokiosk4.СделатьФото));
                }
            }
        }
    }
