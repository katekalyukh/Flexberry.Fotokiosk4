...
moduleForAcceptance('[AGAT] Acceptance | i i s fotokiosk4 печать фото l');

test('testing i-i-s-fotokiosk4-печать-фото-l', function(assert) {
  visit('/i-i-s-fotokiosk4-печать-фото-l');
