...
moduleForAcceptance('[AGAT] Acceptance | i i s fotokiosk4 сделать фото l');

test('testing i-i-s-fotokiosk4-сделать-фото-l', function(assert) {
  visit('/i-i-s-fotokiosk4-сделать-фото-l');
